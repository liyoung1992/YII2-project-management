                    ...
                    'buttons' => [
                        'connect' => function ($url, $model, $key) {
                            ...
                            return  Html::a('<span class="glyphicon glyphicon-user">连接到数据库</span>',
                                "javascript:connect('$model->serverName','$model->dbName','$model->userName','$model->passWord');",
                                ['title' => 12121,'data-pjax'=>'0'] ) ;
                        },
    ...
    function connect(serverName,dbName,userName,password){
        $.ajax({
            ...
            success:function(data){
                window.location.href = "/index.php?r=mysql/connect&key="+data;
                return false;
            },
